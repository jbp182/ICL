...
public class Parser implements ParserConstants {
  ...
  static final public void PL(List<String> ids, List<ASTType> types) throws ParseException {
  Token id;
  ASTType type;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case Id:
  ...
  static final public ASTType getType() throws ParseException {
  ASTType t;
  ASTType type;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4000000,0x20000,0x40060,0x40060,0x200,0xf00000,0x80180,0x80180,0x8f00200,0x8000,0x32011270,0x8000,0x0,0x8000,0x32011270,0x8000,0x200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20d,0x0,0x200,0x0,0x20d,0x0,0x1c0,};
   }
