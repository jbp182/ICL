...
/** ID lister. */
package Components;
import LanguageComponents.Envirements.CodeBlock;import LanguageComponents.Envirements.CompilerEnvirement;import LanguageComponents.Envirements.Environment;import LanguageComponents.Nodes.*;import java.io.FileInputStream;
import java.io.File;
...
public class Parser implements ParserConstants {
  ...
  private static void compile(String fileName) throws Exception{
      ...
      exp.compile(new CompilerEnvirement(null),blk);
      blk.dump("Main.j");
  }
...
{if ("" != null) return f;}
  ...
  static final public ASTNode Fact() throws ParseException {Token n, id;
  ASTNode t, init, body;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case Num:{
...
t = new ASTLet(id.image, init, body);
      break;
      }
    default:
      jj_la1[4] = jj_gen;
...
{if ("" != null) return t;}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x60,0x60,0x180,0x180,0x11270,};
   }
